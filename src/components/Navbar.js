  ...
  return (
    <div>
      <nav className="bg-white border-gray-200">
        <div className="max-w-screen-xl flex items-center justify-between py-4 p-0 sm:px-6 sm:py-8 md:px-6 md:py-8 lg:px-6 lg:py-8 xl:px-6 xl:py-8">
          <div className="flex justify-between items-center">
            <a
              href="/"
              className="flex items-center space-x rtl:space-x-reverse"
            >
              <svg
                width="107"
                height="35"
            ...
            <div
              className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 ms-20"
              id="navbar-cta"
            >
              <ul className="flex flex-col font-medium text-lg p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                  <a
                    href="/"
                    className="block py-2 px-3 md:p-0 text-white bg-blue-700 rounded md:bg-transparent md:text-primary "
                  >
                    Home
                  </a>
                </li>
          ...
          <div className="flex md:order-2 md:space-x-0 rtl:space-x-reverse ">
            <button
              type="button"
              className="text-white bg-black hover:bg-black font-medium text-sm px-8 py-3 me-2 sm:me-0 md:me-0 lg:me-32 xl:me-32 text-center hover:bg-primary rounded-sm"
            >
              Download
            </button>
            <button
